...
#
# frame_left = tk.Frame()
# frame_left.grid(row=100, column=100)
...
# dropdown.pack()
frame1 = tk.Frame(master=window, width=100, height=100, bg=tk_bg)
label_a = tk.Label(frame1, text="Üdvözlöm!", font=font_bold, bg=tk_bg)
label_a.grid(column=0, row=0)
frame1.pack(fill=tk.BOTH, side=tk.LEFT, expand=True, bg=tk_bg)
